...
This repository hosts the for the typeface Trulle Mono, a highly customizable monospaced font. This document describes four distinct variants of Trulle Mono: Trulle Mono Snake, Trulle Mono Slab, Trulle Mono Neue, and the newly added Trulle Mono Streamlined, highlighting their unique characteristics.
...
| :------------- | :--------------------------- | :-------------------------------- | :--------------------------------------------- | :--------------------------------------------- |
| **Serifs**     | Subtle curves/fluid| Prominent slab serifs   | Sans-serif (no serifs)               | Utterly serifless and hookless, rounded vowels |
| **Visual Feel**| Artistic, flowing  | Bold, sturdy, typewriter-like| Clean, modern, minimalist            | Airy, highly legible, unobtrusive              |
| **Coding Suitability** | Less ideal (subtle curves)| Good (distinct characters)| Highly recommended (clean, clear)    | Exceptional (optimized spacing, coding ligatures)|
...
### Trulle Mono Streamlined
![Trulle Mono Streamlined Sample](trulle-mono-streamlined-sample.png)
